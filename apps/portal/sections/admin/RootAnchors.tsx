...
export default function AdminRootAnchors() {
  ...
  return (
    <div className="space-y-5">
                ...
                <tr key={root.id} className="hover:bg-slate-50/70">
                  ...
                  <td className="relative px-5 py-3 text-right">
                    <button
                      type="button"
                      onClick={() =>
                        setActionMenu((current) => (current === root.id ? null : root.id))
                      }
                    ...
                    {actionMenu === root.id && (
                      <div className="absolute right-8 top-11 z-20 w-40 overflow-hidden rounded-lg border border-slate-200 bg-white py-1 text-left shadow-xl">
                        {!root.revokedAt && (
                          <button
                            type="button"
      ...
      <footer className="flex flex-col gap-2 border-t border-slate-200 px-1 pb-1 pt-4 text-xs text-slate-500 md:flex-row md:items-center md:justify-between">
